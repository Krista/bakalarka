...
public class mostPoss2Test {
   ...
   @Before
    ...
    public void prve0() throws Porucha{
      ...
      boolean[] pom1 = {false, false,false,false,true,true, true,true,true,true,true};
...
//       System.out.println(Arrays.toString(rules.step_2[2]));
      assertTrue(Arrays.equals(pom0, rules.step_2[0]));
      assertTrue(Arrays.equals(pom1, rules.step_2[1]));
      assertTrue(Arrays.equals(pom2, rules.step_2[2]));
    }
    ...
    public void prve1() throws Porucha{
      ...
      boolean[] pom1 = {false, false,false,true,true, true,true,true,true,true,true};//??
       rules.CoToDa(1);
//        System.out.println(Arrays.toString(rules.step_2[0]));
//        System.out.println(Arrays.toString(rules.step_2[1]));
      assertTrue(Arrays.equals(pom0, rules.step_2[0]));
      assertTrue(Arrays.equals(pom1, rules.step_2[1]));
       }
    ...
    public void prve2() throws Porucha{
      boolean[] pom0 = {true, true,true,true,true,true, true,true,true,false,false};
      boolean[] pom1 = {false, false,false,true,true,true, true,true,true,true,true};
      rules.CoToDa(2);
//        System.out.println(Arrays.toString(rules.step_2[0]));
//        System.out.println(Arrays.toString(rules.step_2[1]));
    ...
    public void prve3() throws Porucha{
      boolean[] pom0 = {true, true,true,true,true,false, false,false,false,false,false};
      boolean[] pom1 = {false, false,true,true,true,false, true,true,true,false,false};
...
//        System.out.println(Arrays.toString(rules.step_2[2]));
    ...
    public void prve4() throws Porucha{
      boolean[] pom0 = {true, true,true,true,true,false, false,false,false,false,false};
      boolean[] pom1 = {false, false,false,true,true,false, false,true,true,true,true};
      boolean[] pom2 = {false, false,false,false,false,false, true,true,true,true,true};
      rules.CoToDa(4);
//        System.out.println(Arrays.toString(rules.step_2[1]));
//        System.out.println(Arrays.toString(rules.step_2[2]));
