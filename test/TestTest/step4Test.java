...
public class step4Test {
   ...
   @Before
    ...
    @Test
    public void cierne0() throws Porucha{
      boolean[] pom0 = {true,true,true,true,true, true,true,true,true,true};
      
      rules.CoToDa(0);
      //System.out.println(Arrays.toString(rules.c_black));
      assertTrue(Arrays.equals(pom0, rules.c_black));
    
    }
    
       @Test
    public void cierne1() throws Porucha{
      boolean[] pom0 = {true,true,true,false,false, false,true,true,true,true};
      ...
      assertTrue(Arrays.equals(pom0, rules.c_black));
       ...
       @Test
    public void cierne2() throws Porucha{
      boolean[] pom0 = {true,true,true,true,false, false,false,false,false,false};
      ...
      assertTrue(Arrays.equals(pom0, rules.c_black));
       ...
       @Test
    public void cierne3() throws Porucha{
      boolean[] pom0 = {true,true,true,false,true, true,false,false,false,false};
      ...
      assertTrue(Arrays.equals(pom0, rules.c_black));
       ...
       @Test
    public void cierne4() throws Porucha{
      boolean[] pom0 = {true,true,false,true,true, true,false,true,true,true};
      ...
      @Test
    public void cierne5() throws Porucha{
      boolean[] pom0 = {true,true,true,true,true, false,true,true,true,true};
